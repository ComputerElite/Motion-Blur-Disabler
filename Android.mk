...
include $(CLEAR_VARS)
LOCAL_MODULE := MotionBlurDisabler_0_1_0
...
LOCAL_LDLIBS += -llog
LOCAL_CFLAGS += -I'extern/libil2cpp/il2cpp/libil2cpp' -DID='"MotionBlurDisabler"' -DVERSION='"0.1.0"' -I'./shared' -I'./extern' -isystem'extern/codegen/include'
